...
const Jason = () => {
  useGSAP(() => {
    ...
    gsap
      ...
      .to(".first-vid", { opacity: 0, duration: 1, ease: "power1.inOut" });
  ...
  return (
    <section className="jason">
      <div className="max-w-lg jason-content">
        <h1>Jason David</h1>
        <h2>Jason wants an easy life, but things jsut keep getting harder</h2>
        <p>
          Jason grew up around grifters and crooks. After a stint in the Army
          trying to shake off his trouble teens, he found himself in the key
